...
MODEL_PATH = "/gpfs/work4/0/prjs1338/saved_models/Data=AudioSet/WithNoise=True/Model=SpatialMamba/ModelSize=base/NrGpus=1/LR=0.0002/BatchSize=32/NrSamples=16/Patching=time/MaskPatch=80/InputL=200/Cluster=False/step=64000.ckpt"

config = Config({"model": Config({"mlp_ratio":4.,
                    "d_state": 24 ,
                    "d_conv": 4,
                    "expand": 3, 
                    "rms_norm": True ,
